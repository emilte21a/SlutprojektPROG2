...
public class Animator : Component
{
    ...
    {
        Raylib.DrawTextureRec(spriteSheet, new Rectangle(_frame * spriteSheet.Width / maxFrames, 0, spriteSheet.Width / maxFrames, spriteSheet.Height), position, Color.White);
    }
}